...
const badgeVariants = cva(
  'inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        default: 'border-transparent bg-primary text-primary-foreground shadow-sm hover:bg-primary-700',
        ...
        negative: 'border-transparent bg-negative text-negative-foreground shadow-sm hover:bg-negative-900 dark:hover:bg-negative-700',
        positive: 'border-transparent bg-positive text-positive-foreground shadow-sm hover:bg-positive-600',
