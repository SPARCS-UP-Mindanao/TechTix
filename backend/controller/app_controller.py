def api_controller(app):
    ...
    from controller.pycon_registration_controller import pycon_registration_router
    ...
    app.include_router(pycon_registration_router, prefix='/pycon/registrations', tags=['PyCon Registrations'])
