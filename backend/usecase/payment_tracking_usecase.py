...
class PaymentTrackingUsecase:
    ...
    def process_payment_event(self, message_body: dict):
        ...
        try:
            ...
            self.payment_transaction_repository.update_payment_transaction_status(
    ...
    def _create_and_save_registration(self, registration_details, registration_data, status):
        ...
        self.registration_repository.store_registration(
            registration_in=PyconRegistrationIn(**registration_item_data), registration_id=registration_id
        )

    def _send_email_notification(self, registration_data: PyconRegistrationOut, status: str, event_id: str):
        event_detail = self.event_repository.query_events(event_id)
